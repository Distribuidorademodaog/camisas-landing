# -*- coding: utf-8 -*-
"""
Lote 3 de ciudades: 8 paginas nuevas + modulo de ciudades 21 -> 29 — 2026-09-24.
...
Que hace:
  1. Escribe _cities/<slug>.meta.json y .section.html desde _cities/lote3_datos.py
  ...
  4. Modulo `cities-footer-grid`: 29 -> 36 ciudades en todas las paginas que
...
Uso:  python ciudades_lote3_2026_09_24.py [--dry-run]
"""
import glob
...
from lote3_datos import CIUDADES  # noqa: E402
...
CIUDADES_NAV = [
    ...
    # lote 3 (2026-09-24): las ciudades siguen siendo el activo que mejor rinde
    # del sitio —26,3 clics/1.000 frente a 6,0 del blog— y las 8 del lote 2
    # entraron al indice en 7 dias.
    ("girardot", "Girardot"), ("yopal", "Yopal"), ("villa-del-rosario", "Villa del Rosario"),
    ("apartado", "Apartadó"), ("turbo", "Turbo"), ("magangue", "Magangué"),
    ("maicao", "Maicao"),
]
...
def main():
    ...
    print("modulo de ciudades (36) reescrito en %d paginas" % n_mod)
